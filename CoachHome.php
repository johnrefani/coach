...
<body>
    ...
    <section class="main fade-in">
        <video autoplay loop muted plays-inline class="bg-video">
            <source src="img/CodeVid3.mp4" type="video/mp4">
        </video>
        <div class="left">
            ...
            <div class="header-container">
                ...
                <img src="img/code.gif" alt="Coding Animation" class="laptop-right">
            </div>
            <img src="img/Trusted.png" alt="Trusted" class="trusted-right">
        </div>
        <div class="right">
    ...
    <section class="info1 fade-in">
        <div class="second">
            ...
            <div class="second-container">
                <img src="img/Girl.png" alt="Girl" class="girl-left"> <!-- Image on the left -->
    ...
    <section class="info2 fade-in">
        <div class="third">
            ...
            <div class="third-container">
                ...
                <img src="img/LogoCoach.png" alt="Coach" class="coach-right">
            </div>
        </div>
        <div class="right1">
    ...
    <section class="featured-courses fade-in">
        ...
        <div class="see-more-wrapper">
          <a href="CoachHome_Courses.php" class="see-more-btn">See More</a>
        </div>
      </section>
      ...
      <section class="mentor-section fade-in">
        <div class="mentor-container">
          <div class="mentor-images">
            <img src="img/GirlLaptop.png" alt="Mentor at laptop" class="mentor-img">
          </div>
      ...
      <section class="trusted-section fade-in">
        <div class="trusted-container">
          ...
          <div class="logo-row">
            <img src="img/bpsuwhite.png" alt="BPSU Logo" />
            <img src="img/ccstwhite.png" alt="CCST Logo" />
            <img src="img/archwhite.png" alt="Archwizard Logo" />
      ...
      <section class="partnerships-section fade-in">
        ...
        <div class="partner-cards">
          <div class="partner-card">
            <img src="img/bpsu.png" alt="BPSU Logo">
            <h3>BPSU</h3>
          ...
          <div class="partner-card">
            <img src="img/ccst.png" alt="CCST Logo">
            <h3>CCST</h3>
          ...
          <div class="partner-card">
            <img src="img/archwiz.png" alt="ARCHWIZ Logo">
            <h3>ARCHWIZ</h3>
