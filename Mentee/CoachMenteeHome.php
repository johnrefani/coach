...
<head>
  ...
  <link rel="stylesheet" href="css/homemenstyle.css" />
...
<div class="sub-menu-wrap hide" id="profile-menu">
  ...
  <header class="hero">
    <video autoplay muted loop playsinline class="bg-video">
      <source src="img/bgheader.mp4" type="video/mp4" />
  ...
  <section class="about-process-section">
    <div class="about-container">
      <div class="about-image">
        <img src="img/pencil.gif" alt="Tools in cart">
      </div>
      ...
      <div class="skills-container">
        <div class="skills-text">
          ...
          <div class="startingstudent">
            <div class="feature-item">
              <img src="img/logo1.png" alt="Icon 1" />
              <span>Start learning from our experts.</span>
            </div>
            <div class="feature-item">
              <img src="img/logo2.png" alt="Icon 2" />
              <span>Enhance your skills with us now.</span>
            </div>
            <div class="feature-item">
              <img src="img/logo3.png" alt="Icon 3" />
              <span>Do the professional level Course.</span>
            </div>
            <div class="feature-item">
              <img src="img/logo4.png" alt="Icon 4" />
              <span>Develop real-world skills tailored to your goals.</span>
            </div>
          </div>
    
          <a href="CoachMentee.php#courses" class="cta-button">View All Courses</a>
        </div>
        ...
        <div class="skills-images">
          <div class="image-wrapper">
            ...
            <img src="img/laptop1.png" alt="Main Student" class="image-1" />
            <img src="img/code1.gif" alt="Overlay Student" class="image-2" />
          </div>
        </div>
      </div>
    </section>
