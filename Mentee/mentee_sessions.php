...
$notifStmt = $conn->prepare("SELECT COUNT(*) as count FROM booking_notifications WHERE recipient_username = ? AND recipient_type = 'mentee' AND is_read = 0");
...
<head>
  ...
  <style>
    ...
    .fc-event {
      background-color: #6b2a7a !important;
