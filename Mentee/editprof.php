...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_profile'])) {
    ...
    $update_sql = "UPDATE mentee_profiles SET 
                  First_Name = ?, 
                  Last_Name = ?, 
                  Email = ?, 
                  Contact_Number = ?, 
        ...
        if (!in_array(strtolower($ext), $allowed)) {
            ...
            if ($filesize > 5 * 1024 * 1024) {
                ...
                if (move_uploaded_file($_FILES['profile_pic']['tmp_name'], $new_filename)) {
                    ...
                    $update_pic_sql = "UPDATE mentee_profiles SET Mentee_Icon = ? WHERE Username = ?";
...
$sql = "SELECT First_Name, Last_Name, Username, DOB, Gender, Email, Contact_Number, Mentee_Icon 
...
<div class="sub-menu-wrap hide" id="profile-menu">
  <div class="sub-menu">
    ...
    <nav class="tabs">
      ...
      <button class="active" onclick="window.location.href='editprof.php'">Edit Profile</button>
