...
$username = $_SESSION['username']; // Use this consistently for queries
$name = $username; // For displaying in the navbar
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($new_password !== $confirm_password) {
        ...
        $sql = "SELECT Password FROM mentee_profiles WHERE Username = ?";
        ...
        if ($result->num_rows > 0) {
            ...
            if (password_verify($current_password, $stored_hashed_password)) {
                ...
                $update_sql = "UPDATE mentee_profiles SET Password = ? WHERE Username = ?";
...
<div class="sub-menu-wrap hide" id="profile-menu">
  <div class="sub-menu">
    ...
    <nav class="tabs">
      ...
      <button class="active" onclick="window.location.href='resetpass.php'">Reset Password</button>
    </nav>
