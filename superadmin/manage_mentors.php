...
// Mentor rejection (POST request with reason)
...
<script>
    ...
    function showRejectionDialog(id) {
        ...
        document.getElementById('confirmReject').addEventListener('click', () => {
            ...
            // Call the new function to send the rejection request and email
            confirmRejection(id, reason);
            document.body.removeChild(dialog);
        });
    }

    // New function to handle the AJAX call for rejection and email
    ...
    // Note: The old updateStatus and updateStatusWithReason functions were removed
    // as their logic is now integrated into confirmCourseAssignment and confirmRejection.
