...
<script>
    ...
    function viewDetails(id, isApplicant) {
        ...
        let credentialsLink = row.credentials ? `<a href="view_application.php?file=${encodeURIComponent(row.credentials)}&type=credentials" target="_blank"><i class="fas fa-card"></i> View Credentials</a>` : "No Credentials";  
