...
<link rel="stylesheet" href="css/admin_activities.css">
  ...
  <div class="nav-top">
    ...
    <div class="menu-items">
        <ul class="navLinks">
            ...
            <li class="navList active"><a href="activities.php"><ion-icon name="clipboard-outline"></ion-icon><span class="links">Activities</span></a></li>
        ...
        <ul class="bottom-link">
            <li class="logout-link"><a href="#" onclick="confirmLogout(event)"><ion-icon name="log-out-outline"></ion-icon>Logout</a></li>
        </ul>
    </div>
</nav>
...
<script src="js/admin_activities.js"></script>
