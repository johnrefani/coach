...
    border-radius: 5px;
    /* Changed to hidden since we want the table to fit, not scroll */
    overflow-x: hidden; 
}
...
    width: 100%; 
    /* KEY FIX: REMOVED min-width: 1300px; */ 
}
...
    max-width: 40px; /* Heavily constrained */
    min-width: 40px; /* Heavily constrained */
...
    /* Increased flexibility for these columns */
    max-width: 30%; 
...
    max-width: 60px; /* Heavily constrained */
    min-width: 60px; /* Heavily constrained */
    text-align: center;
...
    position: relative;
    text-align: center !important; 
    padding: 12px 5px; /* Reduced padding to match cell */
}
