...
// Get the logged-in admin's information from the 'users' table
$currentUserId = $_SESSION['user_id'];
$displayName = "Unknown Admin"; // Default display name

$sql = "SELECT first_name, last_name FROM users WHERE user_id = ? AND user_type = 'Admin'";
...
// Note: The forum_chats and forum_participants tables are already defined in your new SQL file.
// The create queries below are kept for robustness in case the tables are dropped.
...
<head>
    ...
    <title><?php echo $view === 'forums' ? 'Forums' : 'Forum Chat'; ?> | Admin</title>
